<%-- 
    Document   : login
    Created on : Jan 17, 2025, 8:42:52 PM
    Author     : lenovo
--%>
                        ...
                        <div class="col-12 col-md-6 col-xl-7">
                            <div class="d-flex justify-content-center text-bg-success">
                                <div class="col-12 col-xl-9">
                                    <a href="index.jsp"><img class="img-fluid rounded mb-4" loading="lazy" src="assets/img/Namcombank-Original.jpg" width="200" height="80" alt="Logo"></a>
                                    <hr class="border-success-subtle mb-4">
                                    <h2 class="h1 mb-4">Welcome to Namcombank!</h2>
                                    <p class="lead mb-5">Please enter your credentials to access your account.</p>
                                    <div class="text-end">
                                ...
                                <div class="card-body p-3 p-md-4 p-xl-5">
                                    ...
                                    <form action="login" method="post">
                                        <div class="row gy-3 overflow-hidden">
                                            ...
                                            <div class="col-12">
                                                <p class="text-end">
                                                    <a href="forgot-password.jsp" class="text-decoration-none text-dark">Forgot Password?</a>
                                                </p>
                                            </div>
                                        </div>
                                    </form>
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="d-flex gap-2 gap-md-4 flex-column flex-md-row justify-content-md-end mt-4">
                                                <p class="m-0 text-dark text-center">Don't have an account? <a href="register.jsp" class="link-success text-decoration-none">Sign up</a></p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-12">
                                            <p class="mt-4 mb-4" style="text-align: center">Hello!</p>
