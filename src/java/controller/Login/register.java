...
public class register extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String cic = request.getParameter("cicU");
        CustomerDAO ud = new CustomerDAO();
        if (ud.checkUsername(username, email)) {
            password = ud.toSHA1(password);
            ud.registerAcc(fullname, username, password, email, dob, Integer.parseInt(gender), phone, cic, address);
