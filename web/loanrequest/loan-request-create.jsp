...
<body class="bg-gray-100 text-gray-900">
    <div class="container mx-auto p-6">
        ...
        <div class="max-w-lg mx-auto bg-white p-6 rounded-lg shadow-lg">
            <form action="../loan-request" method="POST" class="space-y-4" onsubmit="return validateLoanAmount();">
                ...
                <div>
                    ...
                    <input type="text" name="loanType" class="w-full p-2 border rounded"
                           value="<%= loanPackage != null ? loanPackage.getLoanType() : "" %>" readonly required>
                </div>
                <div>
                    <label class="block text-gray-700">Description</label>
                    <input name="description" class="w-full p-2 border rounded"
                           value="<%= loanPackage != null ? loanPackage.getDescription() : "" %>" readonly required>
                </div>
                <div>
                    <label class="block text-gray-700">Interest Rate (%)</label>
                    <input type="number" step="0.01" name="interestRate" class="w-full p-2 border rounded"
                           value="<%= loanPackage != null ? loanPackage.getInterestRate() : "" %>" readonly required>
                </div>
                <div>
                ...
                <div>
                    ...
                    <input type="number" name="loanTerm" class="w-full p-2 border rounded"
                           value="<%= loanPackage != null ? loanPackage.getLoanTerm() : "" %>" required>
                </div>
